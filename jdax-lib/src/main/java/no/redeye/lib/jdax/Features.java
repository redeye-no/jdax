...
public enum Features {
    /**
     * Use Statement.RETURN_GENERATED_KEYS to retrieve ID of newly inserted
     * rows.
     * If not set, the DAO will use a named field instead of auto-generated
     * column.
     */
    USE_GENERATED_KEYS_FLAG,
    /**
     * When provided, query results will avoid returning null values for null
     * values in the DB.
