...
public class JDAXFeaturesTestBase extends TestBase {
    ...
    protected InsertResults setUpTest(VO vo, String insertQuery, String tableName, Features... featues) throws SQLException {
        return setUpTest(vo, insertQuery, tableName, "", featues);
    }

    protected InsertResults setUpTest(VO vo, String insertQuery, String tableName, String fields, Features... featues) throws SQLException {
        setUpDS(featues);
        setUpTypesTable(tableName);
        return dbq.insertRow(vo, insertQuery, fields.split(","));
    }
